 ...
 * ### 리뷰
 * - 풀이 방식은 다음과 같다.
 *   절단기의 길이를 기준으로 이분탐색을 진행한다.
 *
 *   (0~최대 나무의 길이) 범위에서 절단기의 길이를 선택하여,
 *   해당 절단기의 길이로 나무들을 절단했을 때의 총 남은 나무의 길이를 구한다.
 *   이때 남은 나무의 길이가 M보다 크거나 작을 경우 더 큰 범위의 절단기의 길이에 대해 탐색하고,
 *   반대로 M보다 작은 경우 더 작은 범위의 절단기의 길이에 대해 탐색한다.
 *
 *   탐색을 마친 후, 가능한 절단기의 최대 길이를 반환한다.
 */
